    ...
    <div className="size-full flex flex-col" style={{ backgroundColor: '#FDFFEC' }}>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 py-16 gap-6">
        <Avatar className="w-44 h-44" style={{ backgroundColor: '#BDBDBD' }}>
          <AvatarFallback className="text-5xl text-white" style={{ backgroundColor: '#BDBDBD' }}>
            {initials}
          </AvatarFallback>
        </Avatar>

        <div className="text-center">
          <h2 className="font-normal" style={{ fontSize: 32, color: '#030303' }}>
            {user?.name || 'First Last Name'}
          </h2>
          <p className="mt-1" style={{ fontSize: 24, color: '#030303' }}>
            {roleDisplay}
          </p>
        </div>
